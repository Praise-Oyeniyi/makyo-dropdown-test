          ...
          <form onSubmit={(e)=>{onSubmit(e)}} className='w-5/6 mx-auto'>
            <div className='w-full space-y-2'>
              <div className='w-full flex gap-x-10 justify-between items-center'>
                ...
                <div ref={triggerRef} id="select" className="min-w-5/6 relative border rounded-sm h-10 px-2 focus:outline-none flex gap-x-2 justify-start items-center overflow-x-auto scrollbar-hide" style={{ borderColor }} onClick={()=>setOpen(!open)}>
